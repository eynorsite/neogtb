...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="dash-header">
        <h1 class="dash-greeting">
            <?php echo e($this->getGreeting()); ?>, <span class="gradient-name"><?php echo e($this->getAdminName()); ?></span> 👋
        </h1>
        <p class="dash-date"><?php echo e($this->getFormattedDate()); ?> — Voici un résumé de votre activité</p>
    </div>
...
<?php endif; ?>
            ...
            <div class="kpi-value"><?php echo e($pages); ?></div>
...
<?php endif; ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($unread > 0): ?>
                    <div class="kpi-trend down">! <?php echo e($unread); ?></div>
                <?php else: ?>
                    <div class="kpi-trend up">✓</div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            <div class="kpi-value"><?php echo e($unread); ?></div>
...
<?php endif; ?>
                ...
                <div class="kpi-trend up"><?php echo e($posts); ?></div>
            </div>
            <div class="kpi-value"><?php echo e($posts); ?></div>
...
<?php endif; ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($overdueGdpr > 0): ?>
                    <div class="kpi-trend down">! <?php echo e($overdueGdpr); ?></div>
                <?php elseif($pendingGdpr > 0): ?>
                    <div class="kpi-trend neutral"><?php echo e($pendingGdpr); ?></div>
                <?php else: ?>
                    <div class="kpi-trend up">✓ OK</div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            <div class="kpi-value"><?php echo e($pendingGdpr); ?></div>
    ...
    <div class="quick-actions">
        <a href="<?php echo e(\App\Filament\Resources\PostResource::getUrl('create')); ?>" class="quick-action">
...
<?php endif; ?>
        ...
        <a href="<?php echo e(url('/admin/pages')); ?>" class="quick-action">
            <div class="quick-action-icon">
                <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
        ...
        <a href="<?php echo e(\App\Filament\Resources\ContactMessageResource::getUrl()); ?>" class="quick-action">
            <div class="quick-action-icon">
                <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
            ...
            <div>
                ...
                <p class="quick-action-desc"><?php echo e($unread); ?> message<?php echo e($unread > 1 ? 's' : ''); ?> non lu<?php echo e($unread > 1 ? 's' : ''); ?></p>
            </div>
        </a>
    ...
    <div class="content-grid">
        ...
        <div class="dash-card">
            <div class="dash-card-header">
                ...
                <a href="<?php echo e(\App\Filament\Resources\ContactMessageResource::getUrl()); ?>" class="dash-card-link">
                    Tout voir →
                </a>
            </div>
            <div class="dash-card-body">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    ...
                    <div class="message-item">
                        <div class="msg-status <?php echo e($msg->status !== 'new' ? 'read' : ''); ?>"></div>
                        <div class="msg-avatar" style="background: <?php echo e($color); ?>"><?php echo e($initials); ?></div>
                        <div class="msg-content">
                            <div class="msg-name"><?php echo e($msg->name); ?></div>
                            <div class="msg-preview"><?php echo e(Str::limit($msg->subject ?: $msg->message, 60)); ?></div>
                        </div>
                        <div class="msg-time"><?php echo e($msg->created_at->diffForHumans(short: true)); ?></div>
                    </div>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-8 h-8 mx-auto mb-2','style' => 'opacity: 0.3;']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
        ...
        <div class="dash-card">
            ...
            <div class="dash-card-body">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $activity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <?php
                    ...
                    <div class="activity-item">
                        <div class="activity-icon <?php echo e($iconClass); ?>">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php switch($iconClass):
                                case ('create'): ?>
                                    <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                        ...
                        <div class="activity-text">
                            <div class="activity-desc">
                                <strong><?php echo e($log->admin?->name ?? 'Système'); ?></strong>
                                <?php echo e($actionLabel); ?>

                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($modelName): ?> un<?php echo e(in_array($modelName, ['SitePage', 'PostCategory']) ? 'e' : ''); ?> <?php echo e($modelName); ?> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
    ...
    <div class="bottom-grid">
        <div class="dash-card">
            <div class="dash-card-header">
                ...
                <a href="<?php echo e(url('/admin/pages')); ?>" class="dash-card-link">Gérer →</a>
            </div>
            <div class="dash-card-body" style="padding: 1rem 1.5rem;">
                <table class="pages-table">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $recentPages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <tr>
                                <td><span class="page-name"><?php echo e($page->name); ?></span></td>
                                <td>
                                    <span class="status-badge <?php echo e($page->is_published ? 'published' : 'draft'); ?>">
                                        <span class="status-dot"></span>
                                        <?php echo e($page->is_published ? 'Publiée' : 'Brouillon'); ?>

                                    </span>
                                </td>
                                <td style="color: var(--neo-text-muted); font-size: 0.75rem;">
                                    <?php echo e($page->updated_at->diffForHumans(short: true)); ?>
            ...
            <div class="dash-card-body">
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                    <div style="text-align: center; padding: 1.25rem; background: #F5F3FF; border-radius: var(--neo-radius-lg);">
                        <div style="font-size: 2rem; font-weight: 800; color: #6C3AED;"><?php echo e($pages); ?></div>
                    ...
                    <div style="text-align: center; padding: 1.25rem; background: #F0FDF4; border-radius: var(--neo-radius-lg);">
                        <div style="font-size: 2rem; font-weight: 800; color: #10B981;"><?php echo e($posts); ?></div>
                    ...
                    <div style="text-align: center; padding: 1.25rem; background: #ECFEFF; border-radius: var(--neo-radius-lg);">
                        <div style="font-size: 2rem; font-weight: 800; color: #06B6D4;"><?php echo e(\App\Models\ContactMessage::count()); ?></div>
                    ...
                    <div style="text-align: center; padding: 1.25rem; background: #FEF2F2; border-radius: var(--neo-radius-lg);">
                        <div style="font-size: 2rem; font-weight: 800; color: #EF4444;"><?php echo e($pendingGdpr); ?></div>
...
<?php endif; ?>
<?php /**PATH /var/www/neogtb/admin/resources/views/filament/pages/dashboard.blade.php ENDPATH**/ ?>