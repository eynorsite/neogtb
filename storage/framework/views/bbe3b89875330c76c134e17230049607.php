...
<head>
    ...
    <meta name="description" content="<?php echo $__env->yieldContent('description', 'NeoGTB - Tout savoir sur la Gestion Technique du Bâtiment (GTB) et la Gestion Technique Centralisée (GTC)'); ?>">
    <link rel="icon" type="image/svg+xml" href="/favicon.svg">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Plus+Jakarta+Sans:wght@600;700;800&display=swap" rel="stylesheet">
    <title><?php echo $__env->yieldContent('title', 'NeoGTB — Gestion Technique du Bâtiment'); ?></title>
    ...
    <footer class="bg-dark-900 text-white mt-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div class="border-t border-dark-700 mt-8 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
                <p class="text-sm text-dark-500">&copy; <?php echo e(date('Y')); ?> NeoGTB. Tous droits réservés.</p>
...
<?php /**PATH /var/www/neogtb/admin/resources/views/front/layouts/app.blade.php ENDPATH**/ ?>