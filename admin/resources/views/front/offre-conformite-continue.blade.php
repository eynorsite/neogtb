    ...
    <div class="max-w-7xl mx-auto px-5 lg:px-10">
        ...
        <div x-data="{ open: 1 }" class="max-w-3xl space-y-3">
            @foreach([
                ...
                ['q' => 'Quelle est la différence entre le décret BACS et la déclaration OPERAT ?', 'a' => 'Ce sont deux obligations distinctes mais liées. Le décret BACS porte sur le système : il impose des fonctions d\'automatisation (art. R. 175-3) — en pratique une GTB de classe A ou B — capables de suivre, analyser et alerter en continu. La déclaration OPERAT relève du décret tertiaire : les bâtiments de plus de 1 000 m² doivent déclarer chaque année leurs consommations sur la plateforme OPERAT de l\'ADEME, pour démontrer leur trajectoire de réduction (-40 % en 2030, -50 % en 2040, -60 % en 2050). Le lien entre les deux, c\'est la GTB : elle produit les données du suivi BACS et celles que vous déclarez sur OPERAT.'],
