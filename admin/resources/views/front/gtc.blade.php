...
<section class="relative min-h-[480px] flex items-center overflow-hidden">
    <img src="/images/hero-gtc.webp" alt="Bâtiment tertiaire intelligent — supervision GTC centralisée" width="1200" height="630" loading="eager" fetchpriority="high" class="absolute inset-0 w-full h-full object-cover object-center" />
    ...
    <div class="max-w-7xl mx-auto px-6 md:px-10 relative z-10 w-full">
        <div class="max-w-[540px]">
            ...
            <p class="text-[17px] text-white/70 leading-relaxed max-w-[480px]">
                La Gestion Technique Centralisée (GTC) désigne le système de supervision qui regroupe la surveillance et le pilotage de tous les équipements techniques d'un ou plusieurs bâtiments sur une interface unique.
            </p>
