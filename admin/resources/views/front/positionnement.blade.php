    ...
    <div class="max-w-[760px] mx-auto px-5 lg:px-10">
        ...
        <div class="lg:hidden space-y-3">
            @foreach([
                ...
                ['q' => 'Commission sur les ventes ?', 'classic' => 'Souvent', 'neo' => '0 €, toujours'],
            ...
            <div class="bg-white border border-dark-100 rounded-2xl p-5">
                ...
                <div class="space-y-3">
                    ...
                    <div class="pt-3 border-t border-dark-100">
                        <p class="text-[10px] uppercase tracking-[0.12em] text-accent-600 font-semibold mb-1">NeoGTB</p>
                        <p class="text-[13px] text-dark-700 leading-relaxed font-medium">{!! $row['neo'] !!}</p>
                    </div>
                </div>
            </div>
            @endforeach
