...
<section class="py-10 lg:py-20">
    <div class="max-w-7xl mx-auto px-5 lg:px-10">
        <div class="mb-10">
            ...
            <h2 class="text-[22px] lg:text-[28px] font-medium text-dark-900 leading-tight tracking-tight">Protocoles de communication</h2>
...
<!-- EQUIPEMENTS PILOTES -->
<section class="py-10 lg:py-20 bg-dark-50">
    <div class="max-w-7xl mx-auto px-5 lg:px-10">
        <div class="mb-10">
            <p class="text-xs font-semibold uppercase tracking-widest text-accent-600 mb-4">Périmètre</p>
            <h2 class="text-[22px] lg:text-[28px] font-medium text-dark-900 leading-tight tracking-tight">Équipements pilotés</h2>
...
<section class="py-10 lg:py-20">
    <div class="max-w-7xl mx-auto px-5 lg:px-10">
        <div class="mb-10">
            ...
            <h2 class="text-[22px] lg:text-[28px] font-medium text-dark-900 leading-tight tracking-tight">Architecture type d'un système GTB</h2>
...
<section class="py-10 lg:py-20 bg-dark-50">
    <div class="max-w-7xl mx-auto px-5 lg:px-10">
        <div class="mb-10">
            ...
            <h2 class="text-[22px] lg:text-[28px] font-medium text-dark-900 leading-tight tracking-tight">Cadre réglementaire</h2>
...
<section class="relative overflow-hidden py-10 lg:py-20 bg-dark-100 border-t border-dark-200">
    ...
    <div class="max-w-7xl mx-auto px-5 lg:px-10 relative z-10 flex items-center min-h-[200px]">
        <div class="max-w-lg">
            <h2 class="text-[22px] lg:text-[28px] font-medium text-dark-900 tracking-tight leading-tight mb-3">Comparer les solutions du marché</h2>
...
<section class="py-12 lg:py-24 bg-white border-t border-dark-100">
    <div class="max-w-7xl mx-auto px-5 lg:px-10">
        <div class="max-w-xl mb-10">
            ...
            <p class="text-base text-dark-500 leading-relaxed">Approfondir les technologies GTB, le cadre légal et les outils pour décider.</p>
        </div>
