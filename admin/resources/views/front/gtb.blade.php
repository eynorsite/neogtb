...
<section class="py-10 lg:py-20">
    <div class="max-w-[760px] mx-auto px-5 lg:px-10">
        <div x-data x-intersect.once="$el.classList.add('animate-fade-in-up')">
            <h2 class="text-[22px] lg:text-[28px] font-medium text-dark-900 tracking-tight leading-tight mb-5">Définition et rôle de la GTB</h2>
...
<section class="py-10 lg:py-20 bg-dark-50 border-t border-b border-dark-200">
    <div class="max-w-7xl mx-auto px-5 lg:px-10">
        <div class="max-w-xl mb-12">
            ...
            <h2 class="text-[22px] lg:text-[28px] font-medium text-dark-900 tracking-tight leading-tight mb-3">Les 4 niveaux ISO 52120-1</h2>
        ...
        <div class="grid md:grid-cols-4 gap-3 lg:gap-5">
            ...
            <div class="{{ $class['highlight'] ? 'bg-white rounded-2xl border border-accent-200 lg:shadow-[0_0_0_3px] lg:shadow-accent-50' : 'bg-white rounded-2xl border border-dark-100 lg:shadow-sm' }} p-5 lg:p-7 card-hover">
...
<section class="py-10 lg:py-20">
    <div class="max-w-7xl mx-auto px-5 lg:px-10">
        <div class="max-w-xl mb-12">
            ...
            <h2 class="text-[22px] lg:text-[28px] font-medium text-dark-900 tracking-tight leading-tight mb-3">Lots techniques pilotés</h2>
...
<section class="py-10 lg:py-20 bg-dark-50 border-t border-b border-dark-200">
    <div class="max-w-7xl mx-auto px-5 lg:px-10">
        <div class="max-w-xl mb-12">
            ...
            <h2 class="text-[22px] lg:text-[28px] font-medium text-dark-900 tracking-tight leading-tight mb-3">Protocoles de communication</h2>
...
<section class="relative overflow-hidden py-10 lg:py-20 bg-dark-100 border-t border-dark-200">
    ...
    <div class="max-w-7xl mx-auto px-5 lg:px-10 relative z-10 flex items-center min-h-[200px]">
        <div class="max-w-lg">
            <h2 class="text-[22px] lg:text-[28px] font-medium text-dark-900 tracking-tight leading-tight mb-3">Évaluez le niveau GTB de votre bâtiment</h2>
...
<section class="py-12 lg:py-24 bg-white border-t border-dark-100">
    <div class="max-w-7xl mx-auto px-5 lg:px-10">
        <div class="max-w-xl mb-10">
            ...
            <p class="text-base text-dark-500 leading-relaxed">Approfondir la GTB, ses obligations et les outils pour situer votre bâtiment.</p>
        </div>
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
            @foreach([
                ...
                ['href' => '/generateur-cee', 'title' => 'Estimateur de primes CEE', 'desc' => 'Évaluez le financement CEE de vos travaux de GTB.'],
            ] as $link)
