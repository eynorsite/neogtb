...
<div x-data="ctaDismiss" data-storage-key="cta_dismiss_{{ $storageKey }}" x-show="show" x-cloak x-transition.opacity.duration.200ms class="my-6 py-3 px-5 border-l-4 border-accent-500 bg-accent-50/60 rounded-lg flex items-center justify-between gap-4">
