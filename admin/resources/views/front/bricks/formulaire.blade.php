        ...
        <div class="rounded-3xl bg-white border border-dark-100 lg:shadow-xl p-5 lg:p-12 animate-fade-in-up">
            ...
            @if(session('contact_success'))
                <div class="mb-10 rounded-2xl bg-gradient-to-br from-accent-50 to-accent-100 border border-accent-200 p-8 text-center animate-fade-in-up">
                    ...
                    <p class="font-heading font-bold text-accent-700 text-lg">{{ $content['message_succes'] ?? 'Message envoyé !' }}</p>
                </div>
            @endif
            ...
            <form method="POST" action="/contact/send" class="space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div class="group">
                        ...
                        <input type="text" name="name" required
                            class="w-full rounded-xl border border-dark-200 bg-dark-50/50 px-4 py-3.5 text-sm text-dark-900 transition-all duration-200 focus:border-primary-500 focus:ring-4 focus:ring-primary-100 focus:bg-white focus:outline-none placeholder:text-dark-500"
                ...
                <div class="group">
                    ...
                    <textarea name="message" required rows="5"
                        class="w-full rounded-xl border border-dark-200 bg-dark-50/50 px-4 py-3.5 text-sm text-dark-900 transition-all duration-200 focus:border-primary-500 focus:ring-4 focus:ring-primary-100 focus:bg-white focus:outline-none resize-none placeholder:text-dark-500"
                ...
                <div class="rounded-2xl border border-dark-100 bg-dark-50/40 p-5">
                    <p class="text-xs leading-relaxed text-dark-500">
                        Vos données sont traitées par NeoGTB pour répondre à votre demande (intérêt légitime, art. 6.1.f RGPD), conservées 3 ans, conformément à notre <a href="/politique-de-confidentialite" class="font-semibold text-primary-600 underline decoration-primary-200 underline-offset-2 hover:text-primary-700 hover:decoration-primary-500 transition-colors">politique de confidentialité</a>.
                    </p>
                </div>
