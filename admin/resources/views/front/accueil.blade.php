...
<head>
    ...
    <meta name="description" content="NeoGTB : le tiers de confiance indépendant de la GTB en France. Diagnostic gratuit, comparateur objectif, veille réglementaire.">
    <link rel="icon" type="image/svg+xml" href="/favicon.svg">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Plus+Jakarta+Sans:wght@600;700;800&display=swap" rel="stylesheet">
    <title>Tiers de confiance indépendant GTB | NeoGTB</title>
    <link rel="stylesheet" href="/css/astro-compiled.css">
</head>
    ...
    <header class="fixed top-0 w-full bg-white/90 backdrop-blur-md border-b border-dark-100 z-50">
        <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            <div class="hidden md:flex items-center gap-8">
                ...
                <a href="/audit" class="inline-flex items-center px-4 py-2 bg-primary-600 text-white text-sm font-semibold rounded-lg hover:bg-primary-700 transition-colors">Diagnostic gratuit</a>
