...
<section class="py-32 text-center">
    <div class="max-w-[600px] mx-auto px-6">
        ...
        <h1 class="font-heading text-[28px] font-medium text-dark-900 tracking-tight mb-3">Inscription confirmée</h1>
        <p class="text-base text-dark-500 leading-relaxed mb-8">
            Vous recevrez la veille GTB mensuelle NeoGTB dans votre boîte mail. 1 email par mois, désabonnement en 1 clic.
        </p>
