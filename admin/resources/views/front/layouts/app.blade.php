          ...
          <div class="mt-8">
            ...
            >
              ...
              <div class="flex gap-2" x-show="!nlSent">
                ...
                <button type="submit" :disabled="nlSending" class="text-[13px] font-medium px-5 py-2.5 rounded-lg text-white transition-all duration-200 hover:shadow-lg hover:shadow-accent-500/20 disabled:opacity-75 disabled:cursor-not-allowed flex items-center gap-2" style="background: linear-gradient(135deg, var(--color-accent-600), var(--color-accent-700));">
                  <span x-show="!nlSending">{{ $site->label('footer.newsletter_button', "S'inscrire") }}</span>
                  <span x-show="nlSending" class="flex items-center gap-1.5">
                    <svg class="w-3.5 h-3.5 animate-spin text-white/80" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="3"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>
