        ...
        GeneralSetting::updateOrCreate(['id' => 1], [
            ...
            'ui_labels' => [
                'about' => [
                    'hero' => [
                        'eyebrow' => 'À propos',
                        'title' => 'Je suis Ulrich Calmo, et j\'ai créé <span class="text-gradient">NeoGTB</span> pour une raison simple',
                        'subtitle' => 'Le marché de la GTB en France manque d\'un interlocuteur neutre. Quelqu\'un qui ne vend rien, qui connaît le terrain, et qui vous aide à prendre la bonne décision. C\'est ce que je fais.',
                    ],
                    'founder' => [
                        'name' => 'Ulrich Calmo',
                        'role' => 'Fondateur de NeoGTB',
                        'company' => 'EYNOR — Eysines, Bordeaux',
                    ],
                    'story' => [
                        'title' => 'Pourquoi j\'ai créé NeoGTB',
                        'content' => '<p>En travaillant sur des projets de gestion technique du bâtiment, j\'ai constaté un problème récurrent : <strong class="text-dark-900 font-medium">les décideurs n\'ont personne vers qui se tourner pour un avis neutre.</strong> Chaque interlocuteur vend sa solution. Les bureaux d\'études prescrivent ce qu\'ils connaissent. Les installateurs poussent leurs partenariats.</p><p>J\'ai créé NeoGTB pour combler ce vide. Ma mission : <strong class="text-dark-900 font-medium">éduquer le marché français sur la GTB</strong>, fournir des outils d\'analyse indépendants, et permettre à chaque professionnel de comprendre, comparer et décider en connaissance de cause.</p><p>NeoGTB est une marque de ma société <strong class="text-dark-900 font-medium">EYNOR</strong>, basée à Eysines près de Bordeaux. Je travaille seul, et c\'est un choix assumé : pas d\'actionnaires fabricants, pas de pression commerciale, pas de compromis sur les recommandations.</p><p>Mon seul engagement, c\'est envers vous : vous donner les clés pour décider en toute connaissance de cause, sans qu\'un intérêt commercial vienne fausser l\'analyse.</p>',
                    ],
                    'method' => [
                        'title' => 'Ma méthode — 4 phases',
                        'subtitle' => 'Une approche structurée pour accompagner chaque projet GTB, du diagnostic à la mise en œuvre.',
                    ],
                    'cta' => [
                        'title' => 'Un projet GTB à clarifier ?',
                        'subtitle' => 'Échangeons sur votre situation. Sans engagement, sans pression commerciale.',
                        'button' => 'Me contacter directement',
                    ],
                ],
                'audit' => [
                    'breadcrumb' => 'Pré-diagnostic GTB',
                    'hero' => [
                        'eyebrow' => 'Diagnostic gratuit · Rapport PDF',
                        'title' => 'Pré-diagnostic <span style="color: #2DD4BF;">GTB</span> de votre bâtiment',
                        'subtitle' => 'Évaluez votre conformité au décret BACS, estimez vos économies d\'énergie et recevez un rapport personnalisé avec recommandations ISO 52120-1.',
                        'badge1' => 'ISO 52120-1 · Décret BACS · Données ADEME',
                        'badge2' => '100% indépendant · 0 € commission',
                    ],
                    'step1_title' => 'Décrivez votre bâtiment',
                    'step1_subtitle' => 'Ces données permettent d\'estimer votre obligation réglementaire et vos références de consommation ADEME.',
                    'age_before1975' => 'Avant 1975',
                    'age_1975_2000' => '1975 — 2000',
                    'age_2000_2012' => '2000 — 2012',
                    'age_after2012' => 'Après 2012 (RT2012 / RE2020)',
                    'step2_title' => 'Vos lots techniques',
                    'step2_subtitle' => 'Décrivez les équipements et usages de votre bâtiment. Ces informations sont essentielles pour dimensionner votre GTB.',
                    'lot_heating' => 'Chauffage',
                    'lot_heating_desc' => 'Surface gérée par le système de chauffage',
                    'heated_surface' => 'Surface chauffée',
                    'lot_ecs' => 'Eau chaude sanitaire (ECS)',
                    'lot_ecs_desc' => 'Production et distribution d\'eau chaude',
                    'has_ecs_question' => 'Votre bâtiment dispose-t-il d\'une production ECS ?',
                    'ecs_surface' => 'Surface desservie par l\'ECS',
                    'lot_cooling' => 'Climatisation / Refroidissement',
                    'lot_cooling_desc' => 'Système de climatisation, groupes froids, CTA',
                    'has_cooling_question' => 'Votre bâtiment est-il climatisé ?',
                    'cooled_surface' => 'Surface climatisée',
                    'lot_lighting' => 'Éclairage',
                    'lot_lighting_desc' => 'Gestion de l\'éclairage intérieur et extérieur',
                    'has_lighting_question' => 'L\'éclairage est-il géré de manière centralisée ?',
                    'lit_surface' => 'Surface éclairée',
                    'lighting_type' => 'Type de gestion',
                    'lighting_manual' => 'Manuel',
                    'lighting_timer' => 'Minuteries',
                    'lighting_presence' => 'Détection de présence',
                    'lighting_smart' => 'Gestion intelligente',
                    'lot_auxiliary' => 'Auxiliaires',
                    'lot_auxiliary_desc' => 'Contacts de porte, domotique, station météo, sous-comptage, stores, ventilation / CTA...',
                    'has_auxiliary_question' => 'Votre bâtiment dispose-t-il d\'équipements auxiliaires ?',
                    'auxiliary_surface' => 'Surface concernée par les auxiliaires',
                    'see_results' => 'Voir mon diagnostic',
                    'results' => [
                        'score_label' => 'Score de maturité GTB',
                        'savings_label' => 'Économies potentielles estimées',
                        'cee_title' => 'Primes CEE estimées — fiches cumulables',
                        'cee_cta' => 'Affiner avec le simulateur CEE complet',
                        'iso_class' => 'Classe ISO 52120-1',
                        'days_left' => 'jours restants avant l\'échéance',
                        'benchmark_title' => 'Benchmark énergétique',
                        'benchmark_subtitle' => 'Positionnement de votre bâtiment par rapport aux références ADEME.',
                        'benchmark_good' => 'Performant',
                        'benchmark_avg' => 'Moyen',
                        'benchmark_bad' => 'Énergivore',
                        'your_building' => 'Votre bâtiment',
                        'benchmark_sources' => 'Sources : OID/ADEME Baromètre 2022, OPERAT 2021, Arrêté valeurs absolues décret tertiaire (24/11/2020). Économies : NF EN ISO 52120-1:2022.',
                        'energy_title' => 'Récapitulatif de vos consommations',
                        'total' => 'Total',
                        'reco_title' => 'Recommandations personnalisées',
                    ],
                    'premium' => [
                        'badge' => 'Aller plus loin',
                        'title' => 'Ce diagnostic est une estimation basée sur vos déclarations',
                        'desc' => 'Pour une analyse précise avec mesures terrain, un expert indépendant peut auditer votre bâtiment et identifier les gisements d\'économies réels.',
                        'online_title' => 'Diagnostic en ligne',
                        'online_subtitle' => 'Ce que vous venez de faire',
                        'online_1' => 'Score ISO 52120-1 estimé',
                        'online_2' => 'Benchmark ADEME indicatif',
                        'online_3' => 'Recommandations génériques',
                        'online_4' => 'Rapport PDF basique',
                        'online_price' => 'Gratuit',
                        ...
                        'onsite_6' => 'Dossier CEE pré-constitué',
                        'onsite_cta' => 'Demander un audit sur site',
                    ],
                    'disclaimer' => [
                        'title' => 'Estimation indicative',
                        'text' => 'Ce résultat est basé sur vos déclarations et des données statistiques (OID/ADEME 2022, OPERAT 2021, NF EN ISO 52120-1:2022). Il ne constitue pas un document réglementaire. NeoGTB est indépendant et ne perçoit aucune commission.',
                    ],
                    'actions' => [
                        'download_pdf' => 'Télécharger le rapport PDF',
                        'contact_expert' => 'Être contacté par un expert',
                        'compare' => 'Comparer les solutions GTB',
                        'estimate_cee' => 'Estimer mes aides CEE',
                        'new_diag' => 'Nouveau diagnostic',
                    ],
                    'modal' => [
                        'title' => 'Recevoir votre rapport PDF',
                        'subtitle' => 'Entrez votre email pour télécharger votre diagnostic complet.',
                        'email_placeholder' => 'votre@email.com',
                        'name_placeholder' => 'Votre nom (optionnel)',
                        'company_placeholder' => 'Entreprise (optionnel)',
                        'consent_text' => 'J\'accepte que NeoGTB utilise mon email pour m\'envoyer mon rapport d\'audit personnalisé et, le cas échéant, un suivi conseil.',
                        'consent_error' => 'Merci de cocher cette case pour recevoir votre rapport.',
                        'rgpd_title' => 'Information RGPD (art. 13)',
                        'rgpd_text' => 'Responsable : NeoGTB. <strong>Finalité</strong> : envoi du rapport d\'audit GTB personnalisé et suivi conseil. <strong>Base légale</strong> : consentement. <strong>Durée de conservation</strong> : 3 ans à compter du dernier contact. Vous disposez d\'un droit d\'accès, de rectification, d\'effacement, de limitation, d\'opposition et de portabilité, ainsi que du droit de retirer votre consentement à tout moment, via <a href="/mes-droits-rgpd" style="color:var(--color-accent-600);">/mes-droits-rgpd</a>. Détails : <a href="/politique-de-confidentialite" style="color:var(--color-accent-600);">politique de confidentialité</a>.',
                        'download_btn' => 'Télécharger',
                        'success' => 'PDF téléchargé !',
                    ],
                    'trust_badge' => 'Outil indépendant — NeoGTB ne perçoit aucune commission',
                    'related' => [
                        'title' => 'Pages associées',
                        'comparateur' => 'Comparateur GTB',
                        'comparateur_desc' => 'Comparez les solutions après votre diagnostic.',
                        'cee' => 'Simulateur CEE',
                        'cee_desc' => 'Estimez vos primes pour financer votre projet GTB.',
                        'reglementation' => 'Réglementation GTB',
                        'reglementation_desc' => 'Décret BACS, calendrier des obligations.',
                    ],
                ],
                'blog' => [
                    'all_articles' => 'Tous les articles',
                    'no_articles' => 'Aucun article dans cette catégorie.',
                    'cta_title' => 'Un projet GTB à clarifier ?',
                    'cta_description' => 'Pré-diagnostic ISO 52120-1 gratuit en ligne, ou échange de 15 minutes pour cadrer votre besoin.',
                    'also_read' => 'À lire aussi',
                ...
                'contact' => [
                    ...
                    'info_response_time' => 'Temps de réponse',
                    'response_time_value' => 'Sous 48h',
                    'trust_badge' => 'Tiers de confiance indépendant — aucun démarchage',
                    'success_title' => 'Merci pour votre demande.',
                    'success_message' => 'Nous avons bien reçu votre message et reviendrons vers vous sous 48h ouvrées.',
                ],
                'cookie' => [
                ...
                'cta' => [
                    'start_diagnostic' => 'Lancer le diagnostic',
                    'contact_me' => 'Me contacter',
                    'back_to_blog' => 'Retour aux Perspectives',
                ],
                'faq' => [
                ...
                'footer' => [
                    'brand_description' => 'Le tiers de confiance indépendant de la Gestion Technique du Bâtiment en France. Aucun lien commercial avec les fabricants.',
                    'newsletter_subtitle' => 'Veille GTB mensuelle',
                    'newsletter_sr_label' => 'Email pour la veille GTB',
                    'newsletter_placeholder' => 'votre@email.com',
                    'newsletter_aria' => 'Votre adresse email pour la veille GTB mensuelle',
                    'newsletter_button' => 'S\'inscrire',
                    'newsletter_success' => 'Un email de confirmation vous a été envoyé. Cliquez sur le lien pour valider votre inscription.',
                    'newsletter_consent' => 'J\'accepte de recevoir la veille GTB mensuelle. <a href="/politique-de-confidentialite" class="underline hover:text-dark-700">Confidentialité</a>',
                    'newsletter_frequency' => '1 email/mois. Désabonnement en 1 clic.',
                    ...
                    'nav_comparateur' => 'Comparateur',
                    'nav_reglementation' => 'Réglementation',
                    'nav_blog' => 'Perspectives',
                    'nav_audit' => 'Pré-diagnostic GTB',
                    'nav_generateur_cee' => 'Générateur CEE',
                    'nav_tables_modbus' => 'Tables Modbus',
                    'nav_contact' => 'Contact',
                    'nav_faq' => 'FAQ',
                    'nav_mentions' => 'Mentions légales',
                    'nav_confidentialite' => 'Confidentialité',
                    'nav_cookies' => 'Cookies',
                    'nav_rgpd' => 'Vos droits RGPD',
                ...
                'forms' => [
                    ...
                    'climate_zone' => 'Où se situe votre bâtiment ?',
                    'continue' => 'Continuer',
                    'previous' => 'Précédent',
                    'next' => 'Suivant',
                    'yes' => 'Oui',
                    ...
                    'subject_quote' => 'Avis sur un devis',
                    'subject_tech' => 'Aide au choix technologique',
                    'subject_regulation' => 'Question réglementaire',
                    'subject_audit' => 'Demande d\'audit',
                    'subject_other' => 'Autre',
                    'message' => 'Message',
                    'message_placeholder' => 'Décrivez votre contexte...',
                    'submit' => 'Envoyer ma demande',
                    'sending' => 'Envoi en cours...',
                    'rgpd_consent' => 'J\'accepte que mes données soient traitées par NeoGTB pour répondre à ma demande (intérêt légitime, art. 6.1.f RGPD). Conservées 3 ans.',
                    'privacy_link' => 'Politique de confidentialité',
                    'rights_link' => 'Exercer vos droits',
                ],
                'layout' => [
                ...
                'legal' => [
                    ...
                    'rgpd' => [
                        'eyebrow' => 'RGPD — Vos droits',
                        'title' => 'Exercer vos droits RGPD',
                        'subtitle' => 'Conformément au RGPD, vous disposez de droits sur vos données personnelles. Sélectionnez le type de demande ci-dessous.',
                        'security_title' => 'Vos données sont protégées',
                        'security_text' => 'Votre demande sera chiffrée et traitée dans un délai légal de 30 jours. Seul le responsable RGPD de NeoGTB y aura accès.',
                        'success_title' => 'Demande enregistrée',
                        'success_text' => 'Nous avons bien reçu votre demande. Vous recevrez une confirmation par email et une réponse dans un délai maximum de 30 jours.',
                        'back_link' => 'Consulter notre politique de confidentialité',
                    ],
                ],
                'misc' => [
                ...
                'nav' => [
                    ...
                    'help_prompt' => 'Besoin d\'aide pour choisir ?',
                    'help_cta' => 'Contactez un expert',
                    'mobile_rgpd' => 'Mes droits RGPD',
                ],
                'newsletter' => [
                    'confirmed' => [
                        'title' => 'Inscription confirmée',
                        'text' => 'Vous recevrez la veille GTB mensuelle NeoGTB dans votre boîte mail. 1 email par mois, désabonnement en 1 clic.',
                ...
                'positionnement' => [
                    'problem' => [
                        'eyebrow' => 'Le problème',
                        'title' => 'Pourquoi le conseil GTB classique pose problème',
                    ],
                    'verify' => [
                        'eyebrow' => 'Vérifiez vous-même',
                        'title' => 'Comment savoir si un conseil GTB est vraiment indépendant',
                    ],
                    'model' => [
                        'eyebrow' => 'Transparence',
                        'title' => 'Comment NeoGTB gagne de l\'argent',
                        'subtitle' => 'Un site gratuit qui ne vend rien — vous avez raison de vous demander où est le piège. Il n\'y en a pas. Voici le modèle, en clair.',
                        'footer' => 'Vous avez encore un doute ? C\'est normal. <a href="/contact" class="text-accent-600 hover:text-accent-700">Posez la question</a>, on y répond.',
                    ],
                    'cta' => [
                        'title' => 'Testez l\'approche',
                        'subtitle' => 'Pré-diagnostic ISO 52120-1 gratuit, comparateur sans biais, générateur CEE. Aucune inscription requise.',
                    ],
                ],
                'search' => [
                ...
                'sticky_cta' => [
                    'aria_label' => 'Accès rapide au pré-diagnostic',
                    'badge' => 'Gratuit · 5 min',
                    'title' => 'Pré-diagnostic GTB ISO 52120-1',
                    'button' => 'Lancer',
                    'dismiss' => 'Masquer',
                ],
                'validation' => [
                    ...
                    [
                        ...
                        'items' => [
                            ...
                            [
                                ...
                                'answer' => "Si votre bâtiment est tertiaire (bureaux, commerces, enseignement, santé...) et que sa puissance CVC dépasse 290 kW, vous êtes concerné depuis le 1er janvier 2025. Pour les bâtiments entre 70 et 290 kW, l'échéance est fixée à 2030. Pour les bâtiments neufs avec permis postérieur au 21/07/2021, c'est obligatoire dès la construction. Le décret impose des fonctions d'automatisation (art. R. 175-3), pas une classe ; la classe B est le niveau couramment visé et la condition de la prime CEE. <a href='/audit' class='text-accent-600 hover:text-accent-700'>Faites le diagnostic gratuit</a> pour savoir où vous en êtes.",
                            ],
                            [
                                'question' => "Que signifient les classes A, B, C, D de la norme ISO 52120-1 (ex-EN 15232) ?",
                                'answer' => "La norme ISO 52120-1 (ex-EN 15232) classe les systèmes de gestion technique en 4 niveaux. <strong>Classe D</strong> : aucune automatisation, pas performant. <strong>Classe C</strong> : automatisation standard, conforme au décret BACS. <strong>Classe B</strong> : automatisation avancée avec supervision centralisée — niveau couramment visé et condition de la prime CEE. <strong>Classe A</strong> : haute performance, avec optimisation énergétique et gestion prédictive. Notre <a href='/audit' class='text-accent-600 hover:text-accent-700'>diagnostic gratuit</a> vous situe sur cette échelle.",
                            ],
                            [
